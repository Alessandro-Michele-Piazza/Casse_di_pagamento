        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Link
              ...
              className="group inline-flex min-h-12 items-center justify-center gap-2 rounded bg-blue-600 px-6 text-sm font-bold text-white transition hover:bg-blue-500 hover:-translate-y-1 active:translate-y-0.5"
            >
              {primaryCta.label}{" "}
              <ArrowRight
                size={18}
